...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/29 18:17:01 by sguarien          #+#    #+#             */
/*   Updated: 2023/05/29 18:17:02 by sguarien         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	move_unicorn(t_game *game, int col, int line, int pressed_key)
{
	int	valid;
	int	tcol;
	int	tline;
...
int	key_handler(int keycode, t_game *game)
{
	...
	if (keycode == A)
		...
		close_window(game);
	if (game->end_game != 1)
		move_unicorn(game, col, line, keycode);
	return (0);
}
